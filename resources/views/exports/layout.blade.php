            ...
            <div class="p-6 max-w-7xl mx-auto">
                    ...
                    <div id="section-models" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($models as $model)
                                @include('exports.partials.model-card', ['item' => $model])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-controllers" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($controllers as $controller)
                                @include('exports.partials.controller-card', ['item' => $controller])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-routes" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($routes as $route)
                                @include('exports.partials.route-card', ['item' => $route])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-commands" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($commands as $command)
                                @include('exports.partials.command-card', ['item' => $command])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-services" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($services as $service)
                                @include('exports.partials.service-card', ['item' => $service])
                            @endforeach
                        </div>
                    </div>
                @endif
                ...
                @if (count($jobs) > 0)
                    <div id="section-jobs" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($jobs as $job)
                                @include('exports.partials.job-card', ['item' => $job])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-events" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($events as $event)
                                @include('exports.partials.event-card', ['item' => $event])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-listeners" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($listeners as $listener)
                                @include('exports.partials.listener-card', ['item' => $listener])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-notifications" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($notifications as $notification)
                                @include('exports.partials.notification-card', ['item' => $notification])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-middlewares" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($middlewares as $middleware)
                                @include('exports.partials.middleware-card', ['item' => $middleware])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-form-requests" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($form_requests as $form_request)
                                @include('exports.partials.form-request-card', ['item' => $form_request])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-resources" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($resources as $resource)
                                @include('exports.partials.resource-card', ['item' => $resource])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-policies" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($policies as $policy)
                                @include('exports.partials.policy-card', ['item' => $policy])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-rules" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($rules as $rule)
                                @include('exports.partials.rule-card', ['item' => $rule])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-observers" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($observers as $observer)
                                @include('exports.partials.observer-card', ['item' => $observer])
                            @endforeach
                        </div>
                    </div>
                @endif
                    ...
                    <div id="section-actions" class="content-section fade-in">
                        ...
                        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                            @foreach ($actions as $action)
                                @include('exports.partials.action-card', ['item' => $action])
                            @endforeach
                        </div>
                    </div>
                @endif
