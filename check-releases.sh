...
# Script pour vérifier l'état des releases Laravel Atlas
...
print_message $BLUE "🔍 État des releases Laravel Atlas"
print_message $BLUE "═══════════════════════════════════════"
...
print_message $GREEN "🌐 Packagist : https://packagist.org/packages/grazulex/laravel-atlas"
