...
# Script pour créer une release Laravel Atlas
...
print_message $BLUE "   https://github.com/Grazulex/laravel-atlas/actions/workflows/release.yml"
...
print_message $YELLOW "   - GitHub: https://github.com/Grazulex/laravel-atlas/releases"
print_message $YELLOW "   - Packagist: https://packagist.org/packages/grazulex/laravel-atlas"
